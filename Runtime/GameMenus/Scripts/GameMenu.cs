...
namespace Buck
{
    ...
    public class GameMenu : MonoBehaviour
    {
        ...
        {
            public StringReference PanelName;
        ...
        [SerializeField] StringReference m_menuName;
        ...
        /// </summary>
        public void AddMenuItem(BaseVariable variable, StringReference label, StringReference panelName)
        {
