...
namespace Buck
{
    ...
    public class GameMenuBuilder
    {
        ...
        [SerializeField] GameObject m_boolMenuItemPrefab;
        [SerializeField] GameObject m_numberMenuItemPrefab;
        ...
        GameObject GetPrefabForVariable(BaseVariable variable)
        {
            if (variable is BoolVariable)
                return m_boolMenuItemPrefab;
                
            if (variable is NumberVariable)
                return m_numberMenuItemPrefab;
